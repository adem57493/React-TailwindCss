    ...
    return (
      <div  className="border-2 border-[#0d373e] p-2 rounded-md flex flex-col gap-1 my-4">
        ...
        <button className="px-4 py-2 text-xs md:text-base rounded-md bg-stone-700
         text-stone-400 hover:bg-stone-600 hover:text-stone-100" onClick={handleSave}>Ekle</button>
        <button className="px-4 py-2 text-xs md:text-base rounded-md bg-stone-700
         text-stone-400 hover:bg-stone-600 hover:text-stone-100" onClick={onCancel}>İptal</button>
      </div>
    );
  }
